...
test('extracting hashtags from text', t => {
  ...
  t.deepEqual(_rec._expr(_rec._capt(tags, 'arguments/0'), {
    content: 't.deepEqual(tags, [\'picture\', \'awesome\', \'platzi\', \'ava\', \'100\', \'yes\'])',
    filepath: 'test/utils-test.js',
    line: 6,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"tags","range":[12,16]},{"type":"ArrayExpression","elements":[{"type":"StringLiteral","value":"picture","range":[19,28]},{"type":"StringLiteral","value":"awesome","range":[30,39]},{"type":"StringLiteral","value":"platzi","range":[41,49]},{"type":"StringLiteral","value":"ava","range":[51,56]},{"type":"StringLiteral","value":"100","range":[58,63]},{"type":"StringLiteral","value":"yes","range":[65,70]}],"range":[18,71]}],"range":[0,72]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"tags","range":[12,16]},{"type":{"label":","},"range":[16,17]},{"type":{"label":"["},"range":[18,19]},{"type":{"label":"string"},"value":"picture","range":[19,28]},{"type":{"label":","},"range":[28,29]},{"type":{"label":"string"},"value":"awesome","range":[30,39]},{"type":{"label":","},"range":[39,40]},{"type":{"label":"string"},"value":"platzi","range":[41,49]},{"type":{"label":","},"range":[49,50]},{"type":{"label":"string"},"value":"ava","range":[51,56]},{"type":{"label":","},"range":[56,57]},{"type":{"label":"string"},"value":"100","range":[58,63]},{"type":{"label":","},"range":[63,64]},{"type":{"label":"string"},"value":"yes","range":[65,70]},{"type":{"label":"]"},"range":[70,71]},{"type":{"label":")"},"range":[71,72]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), _rec2._expr(_rec2._capt(['picture', 'awesome', 'platzi', 'ava', '100', 'yes'], 'arguments/1'), {
    content: 't.deepEqual(tags, [\'picture\', \'awesome\', \'platzi\', \'ava\', \'100\', \'yes\'])',
    filepath: 'test/utils-test.js',
    line: 6,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"tags","range":[12,16]},{"type":"ArrayExpression","elements":[{"type":"StringLiteral","value":"picture","range":[19,28]},{"type":"StringLiteral","value":"awesome","range":[30,39]},{"type":"StringLiteral","value":"platzi","range":[41,49]},{"type":"StringLiteral","value":"ava","range":[51,56]},{"type":"StringLiteral","value":"100","range":[58,63]},{"type":"StringLiteral","value":"yes","range":[65,70]}],"range":[18,71]}],"range":[0,72]}',
...
test('encrypt password', t => {
  ...
  t.is(_rec9._expr(_rec9._capt(result, 'arguments/0'), {
    content: 't.is(result, encrypted)',
    filepath: 'test/utils-test.js',
    line: 29,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"result","range":[5,11]},{"type":"Identifier","name":"encrypted","range":[13,22]}],"range":[0,23]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"result","range":[5,11]},{"type":{"label":","},"range":[11,12]},{"type":{"label":"name"},"value":"encrypted","range":[13,22]},{"type":{"label":")"},"range":[22,23]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), _rec10._expr(_rec10._capt(encrypted, 'arguments/1'), {
    content: 't.is(result, encrypted)',
    filepath: 'test/utils-test.js',
    line: 29,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"result","range":[5,11]},{"type":"Identifier","name":"encrypted","range":[13,22]}],"range":[0,23]}',
...
//# sourceMappingURL=../node_modules/.cache/ava/66f1c79360b87e5a4a69cbd1de619589.js.map